...
class Booking
{
     ...
     * @Assert\Type("datetime", message="Attention, la date d'arrivé doit être au bon format !")
     ...
     * @Assert\GreaterThan(propertyPath="startDate", message="Attention la date de départ doit être ultérieure à la date d'arrivé !")
     */
    private $endDate;
    ...
    public function isBookableDates(){
        //Connaître les dates sont impossibles pour l'annonce
    ...
    /**
     * Cette fonction permet de récupérer des journées qui correspondant à ma réservation
     * 
